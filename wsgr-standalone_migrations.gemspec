...
# -*- encoding: utf-8 -*-
# stub: wsgr-standalone_migrations 6.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "wsgr-standalone_migrations".freeze
  s.version = "6.0.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "github_repo" => "ssh://github.com/wsgr/standalone-migrations" } if s.respond_to? :metadata=
